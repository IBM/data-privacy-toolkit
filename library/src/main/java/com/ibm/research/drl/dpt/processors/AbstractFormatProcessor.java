...
public abstract class AbstractFormatProcessor implements FormatProcessor {
    private final static Logger logger = LogManager.getLogger(AbstractFormatProcessor.class);
    ...
    String maskValue(MaskingProvider provider, String originalValue, String fieldIdentifier, FieldRelationship fieldRelationship, Map<String, OriginalMaskedValuePair> processedFields) {
        if (null == fieldRelationship) {
            ...
            return provider.mask(originalValue, fieldIdentifier, fieldRelationship, processedFields);
        }
    }
