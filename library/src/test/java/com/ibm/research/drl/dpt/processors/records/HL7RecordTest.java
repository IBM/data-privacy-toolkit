...
class HL7RecordTest {
    @Test
    void suppressField() throws IOException {
        try (
            ...
            try {
                ...
                HL7Record hl7Record = new HL7Record(message);

                String xref = "/.MSH-3-1";

                assertThat(new String(hl7Record.getFieldValue(xref)),is("HIS"));

                hl7Record.suppressField(xref);

                assertThat(new String(hl7Record.getFieldValue(xref)),is(""));
