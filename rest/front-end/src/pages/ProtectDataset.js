      ...
      <div className='container-fluid'>
        ...
        <div className='form-inline'>
          <div className='form-group'>
            <label htmlFor='useCompound'><input
              id='useCompound' type='checkbox' value={this.state.useCompound} onChange={event => {
                this.setState(
                  Object.assign({}, this.state, { useCompound: event.target.checked })
                )
              }}
                                         /> Use Compound Data Masking
            </label>
          </div>
        </div>
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            ><i className='fa fa-lock' /> Protect
            </a>
          </div>
        </div>
      </div>
        ...
        return (
          <div key={index} className={isDirect}>
            <MaskingProvidersSelector
              selected={identifiedValue} providers={this.props.providers || []} onChange={(providerName) => {
