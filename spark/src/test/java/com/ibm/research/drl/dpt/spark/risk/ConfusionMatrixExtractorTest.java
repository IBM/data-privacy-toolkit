...
public class ConfusionMatrixExtractorTest {
    ...
    public void testNotAggregated() throws IOException {
        OutlierRemovalOptions configuration = mapper.readValue(this.getClass().getResourceAsStream("/filter_not_aggregated.json"), OutlierRemovalOptions.class);
    ...
    public void testTwoAggregatedSameID() throws IOException {
        OutlierRemovalOptions configuration = mapper.readValue(this.getClass().getResourceAsStream("/filter_two_aggregated_same_id.json"), OutlierRemovalOptions.class);
    ...
    public void testTwoAggregatedDifferentID() throws IOException {
        OutlierRemovalOptions configuration = mapper.readValue(this.getClass().getResourceAsStream("/filter_two_aggregated_different_id.json"), OutlierRemovalOptions.class);
    ...
    public void testAggregatedAndNotAggregated() throws IOException {
        OutlierRemovalOptions configuration = mapper.readValue(this.getClass().getResourceAsStream("/filter_aggregated_with_not_aggregated.json"), OutlierRemovalOptions.class);
    ...
    public void testAggregatedMultipleFields() throws IOException {
        OutlierRemovalOptions configuration = mapper.readValue(this.getClass().getResourceAsStream("/filter_one_aggregated_two_fields.json"), OutlierRemovalOptions.class);
